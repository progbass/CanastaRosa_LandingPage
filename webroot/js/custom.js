...
// REGISTER FORM
            window.RegisterForm = function () {
                ...
                register_submit.addEventListener('click', function () {
                    ...
                    $.post("/canastaroca/users/reg", {"name": name, "email": email, "postal_code": code, "mobile": phone, "category": cat,"cat":hm}, function (d) {
                        console.log(d);
                        if (d.r == 1) {
                            $('.success').html("Congratulations ! You are registered successfully.");
                        }
                    });
                    window.registerWindow = new ModalWindow("#registerForm");
                    window.registerWindow.closeWindow();
                });
                register_nav.style.visibility = 'hidden';
...
// REGISTER FORM
            window.InviteForm = function () {
                ...
                var validateForm = function validateForm() {
                    ...
                    //alert(query);
                    var email = document.querySelector('#M_email').value;
                    ...
                    $.post("/canastaroca/users/invitefrnd", {"email": email, "message": mess}, function (d) {
                        console.log(d);
                        if (d.r == 1) {
                              alert("Invitation sent successfully");
                              window.registerWindow = new ModalWindow("#mailForm");
                              window.registerWindow.closeWindow();
                        }
                    });
